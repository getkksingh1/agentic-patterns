...
export const appendixAPrompting: Appendix = {
  id: 'advanced-prompting-techniques',
  title: 'Appendix A: Advanced Prompting Techniques',
  subtitle: 'Comprehensive Guide to Engineering Effective AI Interactions',
  description: 'Master the art and science of prompting large language models through systematic techniques for clarity, reasoning, structure, and advanced interaction patterns.',
  readingTime: '45 min read',
  content: `# Appendix A: Advanced Prompting Techniques
...
Large language models excel at pattern recognition and text generation but often face challenges with tasks requiring complex, multi-step reasoning. This section focuses on techniques designed to enhance these reasoning capabilities by encouraging models to reveal their internal thought processes. Specifically, it addresses methods to improve logical deduction, mathematical computation, and planning.
...
Self-Consistency Result: Based on majority vote (True appears twice), the final answer is "True". 
(Note: A more sophisticated approach would weigh the reasoning quality).
\`\`\`
