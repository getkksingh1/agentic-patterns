...
export const appendixGCodingAgents: Appendix = {
  id: 'coding-agents',
  title: 'Appendix G: Coding Agents',
  subtitle: 'From Vibe Coding to Production-Ready Agent Teams',
  description: 'Master the transition from exploratory "vibe coding" to structured agent-augmented development teams that scale human creativity and accelerate software delivery.',
  readingTime: '28 min read',
  content: `# Appendix G: Coding Agents
...
To achieve state-of-the-art results, the agents must be powered by direct access to frontier models (e.g., Gemini 2.5 PRO, Claude Opus 4, OpenAI, DeepSeek, etc). Using less powerful models or routing requests through intermediary platforms that obscure or truncate context will degrade performance. The framework is built on creating the purest possible dialogue between the human lead and the raw capabilities of the underlying model, ensuring each agent operates at its peak potential.
...
In this collaborative framework, the human developer acts as the Orchestrator, serving as the central intelligence and ultimate authority over the AI agents.
...
As the foundation for any successful agent interaction, the Context Staging Area is where the human developer meticulously prepares a complete and task-specific briefing.
...
By using targeted prompts, we can build a team of specialist agents, each tailored for a specific development task.
...
#### Provision Access to Frontier Models
...
The following diagram illustrates how different specialist agents collaborate within the development workflow:
...
│   Agent         │    │   Agent         │    │    Agent        │
│                 │    │                 │    │                 │
│ • New features  │    │ • Unit tests    │    │ • API docs      │
│ • Boilerplate   │    │ • Integration   │    │ • Code comments │
│ • Prototypes    │    │ • E2E tests     │    │ • README files  │
└─────────────────┘    └─────────────────┘    └─────────────────┘
         │                       │                       │
         └───────────────────────┼───────────────────────┘
                                 │
         ...
         │                       │                       │
┌─────────────────┐    ┌─────────────────┐    ┌─────────────────┐
│   Optimizer     │    │  Process Agent  │    │  Context Stage  │
│   Agent         │    │  (Reviewer)     │    │     Area        │
│                 │    │                 │    │                 │
│ • Performance   │    │ • Code review   │    │ • Brief files   │
│ • Refactoring   │    │ • Bug detection │    │ • Code context  │
│ • Best practices│    │ • Style guide   │    │ • Documentation │
└─────────────────┘    └─────────────────┘    └─────────────────┘
\`\`\`

**Figure 1:** Coding Specialist Examples
...
- GitHub Copilot Research: https://github.blog/research/
