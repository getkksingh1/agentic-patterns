...
export const appendixBAIInteractions: Appendix = {
  id: 'ai-agentic-interactions',
  title: 'Appendix B: AI Agentic Interactions',
  subtitle: 'From GUI to Real World Environment - The Evolution of Agent-Computer and Agent-Environment Interfaces',
  description: 'Explore how AI agents interact with digital interfaces, physical environments, and the emerging paradigms of visual computing and embodied AI assistance.',
  readingTime: '25 min read',
  content: `# Appendix B: AI Agentic Interactions - From GUI to Real World Environment
...
### Visual Perception and GUI Understanding
...
### Leading Agent-Computer Interface Implementations
...
### Real-Time Omnimodal Interaction
