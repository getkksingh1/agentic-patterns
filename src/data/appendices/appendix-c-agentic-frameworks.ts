...
export const appendixCAgenticFrameworks: Appendix = {
  id: 'agentic-frameworks-overview',
  title: 'Appendix C: Quick Overview of Agentic Frameworks',
  subtitle: 'Comprehensive Guide to Leading AI Agent Development Platforms and Libraries',
  description: 'Compare and contrast major agentic frameworks including LangChain, LangGraph, Google ADK, CrewAI, and other specialized platforms for building intelligent agent systems.',
  readingTime: '20 min read',
  content: `# Appendix C: Quick Overview of Agentic Frameworks

The landscape of agentic frameworks offers a diverse spectrum of tools, from low-level libraries for defining agent logic to high-level platforms for orchestrating multi-agent collaboration. This appendix provides a comprehensive overview of the major frameworks available for building intelligent agent systems.
...
**LangChain** operates at the most foundational level, offering the components and standardized interfaces to create sequences of operations, such as calling a model and parsing its output. 
...
The variety of agentic frameworks presents developers with a core trade-off between the granular control of graph-based systems and the streamlined development of more opinionated platforms. Here's a decision matrix:

### Choose Based on Complexity:

**Simple Linear Workflows** → **LangChain**
- Clear, predictable sequences
- RAG applications
- Data extraction pipelines

**Complex Cyclical Workflows** → **LangGraph**
- Agents that need to loop and retry
- Plan-and-execute patterns
- Human-in-the-loop systems

**Team-Based Collaboration** → **CrewAI**
- Role-based agent interactions
- Structured team processes
- Human-like collaboration patterns

**Enterprise Production Systems** → **Google ADK**
...
**Conversational Multi-Agent Systems** → **Microsoft AutoGen**
